 ...
 */
function type(type, context = exports.globalContext) {
 ...
 */
function deprecated(throws = true, context = exports.globalContext) {
    return function (target, field) {
        const constructor = target.constructor;
        const definition = constructor._definition;
...
function defineTypes(target, fields, context = target._context || exports.globalContext) {
